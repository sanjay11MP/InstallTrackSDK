...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /**
     * @return this request's {@link mobpair.com.installtrack.Response.ErrorListener}.
     */
     ...
     * @return This Request object to allow for chaining.
     */
    public mobpair.com.installtrack.Request<?> setRetryPolicy(RetryPolicy retryPolicy) {
     ...
     * @return This Request object to allow for chaining.
     */
    public mobpair.com.installtrack.Request<?> setRequestQueue(RequestQueue requestQueue) {
     ...
     * @return This Request object to allow for chaining.
     */
    public final mobpair.com.installtrack.Request<?> setSequence(int sequence) {
        mSequence = sequence;
        return this;
    }
     ...
     * @return This Request object to allow for chaining.
     */
    public mobpair.com.installtrack.Request<?> setCacheEntry(mobpair.com.installtrack.Cache.Entry entry) {
        mCacheEntry = entry;
        return this;
    }
     ...
     * @return This Request object to allow for chaining.
     */
    public final mobpair.com.installtrack.Request<?> setShouldCache(boolean shouldCache) {
     ...
     * @return This Request object to allow for chaining.
     */
    public final mobpair.com.installtrack.Request<?> setShouldRetryServerErrors(boolean shouldRetryServerErrors) {
     ...
     */
    @Override
    public int compareTo(mobpair.com.installtrack.Request<T> other) {
