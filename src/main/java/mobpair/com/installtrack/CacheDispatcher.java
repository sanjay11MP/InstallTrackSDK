...
public class CacheDispatcher extends Thread {
    ...
    private final mobpair.com.installtrack.Cache mCache;
    ...
    public CacheDispatcher(
            ...
            mobpair.com.installtrack.Cache cache, ResponseDelivery delivery) {
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
        ...
        private final mobpair.com.installtrack.CacheDispatcher mCacheDispatcher;

        WaitingRequestManager(mobpair.com.installtrack.CacheDispatcher cacheDispatcher) {
