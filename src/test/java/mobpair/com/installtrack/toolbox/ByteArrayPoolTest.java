...
public class ByteArrayPoolTest {
    @Test public void reusesBuffer() {
        mobpair.com.installtrack.toolbox.ByteArrayPool pool = new mobpair.com.installtrack.toolbox.ByteArrayPool(32);
    ...
    @Test public void returnsBufferWithRightSize() {
        mobpair.com.installtrack.toolbox.ByteArrayPool pool = new ByteArrayPool(32);
