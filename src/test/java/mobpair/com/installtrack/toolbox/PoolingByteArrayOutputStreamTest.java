...
public class PoolingByteArrayOutputStreamTest {
    @Test public void pooledOneBuffer() throws IOException {
        mobpair.com.installtrack.toolbox.ByteArrayPool pool = new mobpair.com.installtrack.toolbox.ByteArrayPool(32768);
        writeOneBuffer(pool);
        writeOneBuffer(pool);
        writeOneBuffer(pool);
    }
    ...
    @Test public void unpooled() throws IOException {
        mobpair.com.installtrack.toolbox.ByteArrayPool pool = new mobpair.com.installtrack.toolbox.ByteArrayPool(0);
        writeOneBuffer(pool);
        writeOneBuffer(pool);
        writeOneBuffer(pool);
    }
    ...
    private void writeOneBuffer(mobpair.com.installtrack.toolbox.ByteArrayPool pool) throws IOException {
