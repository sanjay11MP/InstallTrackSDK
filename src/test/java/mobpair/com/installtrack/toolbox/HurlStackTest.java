...
import mobpair.com.installtrack.mock.MockHttpURLConnection;
import mobpair.com.installtrack.mock.TestRequest;
import mobpair.com.installtrack.toolbox.HurlStack;
...
public class HurlStackTest {
    ...
    @Test public void connectionForDeprecatedGetRequest() throws Exception {
        ...
        mobpair.com.installtrack.toolbox.HurlStack.setConnectionParametersForRequest(mMockConnection, request);
