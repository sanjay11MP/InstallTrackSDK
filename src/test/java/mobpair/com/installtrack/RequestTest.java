...
public class RequestTest {
    ...
    private class TestRequest extends mobpair.com.installtrack.Request<Object> {
        private Priority mPriority = Priority.NORMAL;
        public TestRequest(Priority priority) {
            super(mobpair.com.installtrack.Request.Method.GET, "", null);
            mPriority = priority;
        }
    ...
    private class UrlParseRequest extends mobpair.com.installtrack.Request<Object> {
