...
import mobpair.com.installtrack.Request.Priority;
...
import mobpair.com.installtrack.mock.MockRequest;
import mobpair.com.installtrack.mock.ShadowSystemClock;
import mobpair.com.installtrack.toolbox.NoCache;
import mobpair.com.installtrack.utils.ImmediateResponseDelivery;
...
public class RequestQueueIntegrationTest {
    ...
    @Mock private RequestQueue.RequestFinishedListener<byte[]> mMockListener;
    @Mock private RequestQueue.RequestFinishedListener<byte[]> mMockListener2;
